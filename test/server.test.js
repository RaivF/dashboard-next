...
describe('server', () => {
  ...
  it('returns health state and manual dashboard statistics', async () => {
    ...
    assert.equal(statistics.manual_applicants_by_date.length, 36)
    ...
    assert.equal(statistics.manual_applicants_by_date.at(-22).date, '2026-07-07')
    assert.equal(statistics.manual_applicants_by_date.at(-22).quantity, 194)
    assert.equal(statistics.manual_applicants_by_date.at(-21).date, '2026-07-08')
    assert.equal(statistics.manual_applicants_by_date.at(-21).quantity, 129)
    assert.equal(statistics.manual_applicants_by_date.at(-20).date, '2026-07-09')
    assert.equal(statistics.manual_applicants_by_date.at(-20).quantity, 169)
    assert.equal(statistics.manual_applicants_by_date.at(-11).date, '2026-07-20')
    assert.equal(statistics.manual_applicants_by_date.at(-11).quantity, 373)
    assert.equal(statistics.manual_applicants_by_date.at(-5).date, '2026-08-03')
    assert.equal(statistics.manual_applicants_by_date.at(-5).quantity, 37)
    assert.equal(statistics.manual_applicants_by_date.at(-4).date, '2026-08-04')
    assert.equal(statistics.manual_applicants_by_date.at(-4).quantity, -2)
    assert.equal(statistics.manual_applicants_by_date.at(-1).date, '2026-08-07')
    ...
    assert.equal(statistics.manual_summary.applicationsTotal, 16767)
    assert.equal(statistics.manual_summary.onlineChannels, 3629)
    assert.equal(statistics.manual_method[0].name, 'Онлайн')
    assert.equal(statistics.manual_method[0].quantity, 3629)
    assert.equal(statistics.manual_method[1].name, 'Очно')
    assert.equal(statistics.manual_method[1].quantity, 13138)
