...
describe('server', () => {
  ...
  it('returns health state and manual dashboard statistics', async () => {
    ...
    assert.equal(statistics.manual_applicants_by_date.length, 41)
    ...
    assert.equal(statistics.manual_applicants_by_date.at(-27).date, '2026-07-07')
    assert.equal(statistics.manual_applicants_by_date.at(-27).quantity, 194)
    assert.equal(statistics.manual_applicants_by_date.at(-26).date, '2026-07-08')
    assert.equal(statistics.manual_applicants_by_date.at(-26).quantity, 129)
    assert.equal(statistics.manual_applicants_by_date.at(-25).date, '2026-07-09')
    assert.equal(statistics.manual_applicants_by_date.at(-25).quantity, 169)
    assert.equal(statistics.manual_applicants_by_date.at(-16).date, '2026-07-20')
    assert.equal(statistics.manual_applicants_by_date.at(-16).quantity, 373)
    assert.equal(statistics.manual_applicants_by_date.at(-10).date, '2026-08-03')
    assert.equal(statistics.manual_applicants_by_date.at(-10).quantity, 37)
    assert.equal(statistics.manual_applicants_by_date.at(-9).date, '2026-08-04')
    assert.equal(statistics.manual_applicants_by_date.at(-9).quantity, -2)
    assert.equal(statistics.manual_applicants_by_date.at(-6).date, '2026-08-07')
    assert.equal(statistics.manual_applicants_by_date.at(-6).quantity, 11)
    assert.equal(statistics.manual_applicants_by_date.at(-1).date, '2026-08-14')
    assert.equal(statistics.manual_applicants_by_date.at(-1).quantity, 30)
    ...
    assert.equal(statistics.manual_summary.applicationsTotal, 17856)
    assert.equal(statistics.manual_summary.onlineChannels, 3901)
    assert.equal(statistics.manual_method[0].name, 'Онлайн')
    assert.equal(statistics.manual_method[0].quantity, 3901)
    assert.equal(statistics.manual_method[1].name, 'Очно')
    assert.equal(statistics.manual_method[1].quantity, 13955)
    ...
    assert.equal(statistics.manual_previous_year_applicants_by_date.length, 43)
    ...
    assert.equal(statistics.manual_previous_year_applicants_by_date.at(-3).date, '2025-08-06')
    assert.equal(statistics.manual_previous_year_applicants_by_date.at(-3).quantity, 87)
    assert.equal(statistics.manual_previous_year_applicants_by_date.at(-1).date, '2025-08-10')
    assert.equal(statistics.manual_previous_year_applicants_by_date.at(-1).quantity, 116)
