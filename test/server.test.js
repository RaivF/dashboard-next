...
describe('server', () => {
  ...
  it('returns health state and manual dashboard statistics', async () => {
    ...
    assert.equal(statistics.manual_applicants_by_date.length, 26)
    ...
    assert.equal(statistics.manual_applicants_by_date.at(-12).date, '2026-07-07')
    assert.equal(statistics.manual_applicants_by_date.at(-12).quantity, 194)
    assert.equal(statistics.manual_applicants_by_date.at(-11).date, '2026-07-08')
    assert.equal(statistics.manual_applicants_by_date.at(-11).quantity, 129)
    assert.equal(statistics.manual_applicants_by_date.at(-10).date, '2026-07-09')
    assert.equal(statistics.manual_applicants_by_date.at(-10).quantity, 169)
    assert.equal(statistics.manual_applicants_by_date.at(-1).date, '2026-07-20')
    assert.equal(statistics.manual_applicants_by_date.at(-1).quantity, 367)
    ...
    assert.equal(statistics.manual_summary.applicationsTotal, 15791)
    assert.equal(statistics.manual_summary.onlineChannels, 3021)
    assert.equal(statistics.manual_method[0].name, 'Онлайн')
    assert.equal(statistics.manual_method[0].quantity, 3021)
    assert.equal(statistics.manual_method[1].name, 'Очно')
    assert.equal(statistics.manual_method[1].quantity, 12770)
