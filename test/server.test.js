...
describe('server', () => {
  ...
  it('returns health state and manual dashboard statistics', async () => {
    ...
    assert.equal(statistics.manual_applicants_by_date.length, 22)
    ...
    assert.equal(statistics.manual_applicants_by_date.at(-8).date, '2026-07-07')
    assert.equal(statistics.manual_applicants_by_date.at(-8).quantity, 194)
    assert.equal(statistics.manual_applicants_by_date.at(-7).date, '2026-07-08')
    assert.equal(statistics.manual_applicants_by_date.at(-7).quantity, 129)
    assert.equal(statistics.manual_applicants_by_date.at(-6).date, '2026-07-09')
    assert.equal(statistics.manual_applicants_by_date.at(-6).quantity, 169)
    assert.equal(statistics.manual_applicants_by_date.at(-1).date, '2026-07-15')
    assert.equal(statistics.manual_applicants_by_date.at(-1).quantity, 221)
    ...
    assert.equal(statistics.manual_summary.applicationsTotal, 13201)
    assert.equal(statistics.manual_summary.onlineChannels, 2414)
    assert.equal(statistics.manual_method[0].name, 'Онлайн')
    assert.equal(statistics.manual_method[0].quantity, 2414)
    assert.equal(statistics.manual_method[1].name, 'Очно')
    assert.equal(statistics.manual_method[1].quantity, 10787)
